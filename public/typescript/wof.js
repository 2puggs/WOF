(() => {
  // src/typescript/constants/displayConstants.ts
  var TILE_DIMENSION = 100;

  // src/typescript/gameObjects/tile.ts
  var Tile = class {
    id;
    height;
    width;
  ...
  // src/typescript/gameObjects/states/tileState.ts
  ...
  // src/typescript/gameObjects/guess.ts
  var Guess = class {
    id;
    letter;
    state;
  ...
  // src/typescript/gameObjects/states/guessState.ts
  ...
  // src/typescript/gameObjects/states/gameState.ts
  ...
  // src/typescript/gameObjects/game.ts
  var Game = class {
    state;
    tiles;
    guesses;
